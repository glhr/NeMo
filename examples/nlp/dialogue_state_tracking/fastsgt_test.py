...
def create_pipeline(dataset_split='train'):
    ...
    print(type(data.utterance_ids))
    print(data.utterance_mask)
    print(data.utterance_segment)
...
callback = get_eval_callback('custom')
eval_iter_callback(tensors, None, schema_preprocessor, eval_dataset)
